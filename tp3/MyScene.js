...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.globalAmbientLightIntensity = 1.0;
    ...
    initLights() {
        ...
        console.log(this.globalAmbientLightIntensity);
        this.setGlobalAmbientLight(0.3, 0.3, 0.3, this.globalAmbientLightIntensity);
    ...
    initMaterials() {
        ...
        this.woodMaterial.setAmbient(0.5, 0.25, 0, 1.0);
        this.woodMaterial.setDiffuse(0.5, 0.25, 0, 1.0);
